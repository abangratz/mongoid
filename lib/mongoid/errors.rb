...
module Mongoid #:nodoc
  module Errors #:nodoc
    ...
    # This error is raised when Attribute Assignment (especially with Multi attributes) goes wrong
    class AttributeAssignmentError < MongoidError
    ...
    class MultiparameterAssignmentErrors < MongoidError
      attr_reader :errors
